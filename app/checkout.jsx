...
const styles = StyleSheet.create({
  ...
  header:             { backgroundColor: '#f97316', paddingTop: 60, paddingBottom: 16, paddingHorizontal: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  optionLabelActive:  { color: '#f97316' },
  ...
  pickupHours:        { fontSize: 12, color: '#f97316', marginTop: 2 },
  ...
  paymentRowActive:   { backgroundColor: '#fff7ed', borderColor: '#f97316' },
  paymentIcon:        { fontSize: 24, marginRight: 12 },
  paymentLabel:       { flex: 1, fontSize: 15, color: '#666', fontWeight: '500' },
  paymentLabelActive: { color: '#f97316', fontWeight: '700' },
  ...
  placeBtn:           { backgroundColor: '#f97316', borderRadius: 14, paddingVertical: 16, alignItems: 'center' },

...
const styles = StyleSheet.create({
  ...
  amount:       { fontSize: 20, fontWeight: '700', color: '#f97316' },
  info:         { fontSize: 13, color: '#999', textAlign: 'center', marginBottom: 32, lineHeight: 20 },
  ordersBtn:    { backgroundColor: '#f97316', borderRadius: 14, paddingVertical: 16, paddingHorizontal: 40, marginBottom: 12, width: '100%', alignItems: 'center' },
  ordersBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  shopBtn:      { borderRadius: 14, paddingVertical: 16, paddingHorizontal: 40, width: '100%', alignItems: 'center', borderWidth: 2, borderColor: '#f97316' },
  shopBtnText:  { color: '#f97316', fontSize: 16, fontWeight: '700' },
});
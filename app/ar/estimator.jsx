...
const styles = StyleSheet.create({
  ...
  coatBtnActive:     { backgroundColor: '#f97316' },
  ...
  liters:            { fontSize: 36, fontWeight: '700', color: '#f97316', marginBottom: 16 },
  cansRow:           { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 16, marginBottom: 20 },
  canCard:           { backgroundColor: '#fff7ed', borderRadius: 12, padding: 16, alignItems: 'center', flex: 1 },
  canCount:          { fontSize: 32, fontWeight: '700', color: '#f97316' },
  canLabel:          { fontSize: 13, color: '#666', marginTop: 4 },
  orText:            { fontSize: 16, color: '#999', fontWeight: '500' },
  shopBtn:           { backgroundColor: '#f97316', borderRadius: 14, paddingVertical: 16, alignItems: 'center' },

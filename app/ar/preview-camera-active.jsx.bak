...
const styles = StyleSheet.create({
  ...
  permBtn:      { backgroundColor: '#b91c1c', borderRadius: 12, paddingHorizontal: 28, paddingVertical: 14, marginBottom: 0 },
  ...
  regionActive: { borderWidth: 2, borderColor: '#b91c1c', borderStyle: 'dashed' },
  ...
  addBtn:       { flex: 3, backgroundColor: '#b91c1c', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  ...
  closeBtn:        { marginTop: 16, backgroundColor: '#b91c1c', borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
